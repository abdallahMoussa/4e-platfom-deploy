    ...
    >
      ...
      >
        <h3 className='text-white fw-bold px-9 mt-10 mb-6'>
          ...
          <span className='fs-8 opacity-75 ps-3'>24  {intl.formatMessage({ id: "Notices" })} </span>
        </h3>
      ...
      <div className='tab-content'>
        <div className='tab-pane fade show active' id='kt_topbar_notifications_1' role='tabpanel'>
          ...
          <div className='py-3 text-center border-top'>
            <Link to={'/notifications-details'} onClick={() => document.getElementById('mainNotificationDev').classList.remove('show')} className='btn btn-color-gray-600 btn-active-color-primary'>
        ...
        <div className='tab-pane fade' id='kt_topbar_notifications_2' role='tabpanel'>
          <div className='d-flex flex-column px-9'>
            <div className='pt-10 pb-0'>
              <h3 className='text-dark text-center fw-bolder'> {intl.formatMessage({ id: "Updates" })}  </h3>

              <div className='text-center text-gray-600 fw-bold pt-1'>
                {intl.formatMessage({ id: "PleaseUpdateInformation" })}
              </div>
              ...
              <div className='text-center mt-5 mb-9'>
                ...
                >
                  {intl.formatMessage({ id: "UpdateNow" })}
                </a>
              </div>
            </div>
            ...
            <div className='text-center px-4'>
              <img
                ...
                alt='metronic'
                src={toAbsoluteUrl('/media/illustrations/sigma-1/1.png')}
              />
            </div>
          </div>
        </div>
        ...
        <div className='tab-pane fade' id='kt_topbar_notifications_3' role='tabpanel'>
          <div className='scroll-y mh-325px my-5 px-8'>
            {defaultLogs.map((log, index) => (
              <div key={`log${index}`} className='py-4'>
                <div className='d-flex align-items-stretch justify-content-between align-items-center me-2'>
