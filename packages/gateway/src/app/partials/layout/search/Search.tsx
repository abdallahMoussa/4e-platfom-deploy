      ...
      >
        ...
        >
          ...
          >
            ...
            <div ref={suggestionsElement} className='mb-4' data-kt-search-element='main'>
              <div className='d-flex flex-stack fw-bold mb-4'>
                <span className='text-muted fs-6 me-2'>{intl.formatMessage({ id: "RecentlySearched" })}:</span>
              </div>
              ...
              <div className='scroll-y mh-200px mh-lg-325px'>
                <div className='d-flex align-items-center mb-5'>
                  ...
                  <div className='d-flex flex-column'>
                    ...
                    <span className='fs-7 text-muted fw-bold'>7 {intl.formatMessage({ id: "Request" })}</span>
                  </div>
                </div>
                ...
                <div className='d-flex align-items-center mb-5'>
                  ...
                  <div className='d-flex flex-column'>
                    ...
                    <span className='fs-7 text-muted fw-bold'>10 {intl.formatMessage({ id: "Task" })}</span>
                  </div>
                </div>
                ...
                <div className='d-flex align-items-center mb-5'>
                  ...
                  <div className='d-flex flex-column'>
                    ...
                    <span className='fs-7 text-muted fw-bold'>15 {intl.formatMessage({ id: "Report" })}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <form className={`pt-1 ${menuState === 'advanced' ? '' : 'd-none'}`}>
            <h3 className='fw-bold text-dark mb-7'>{intl.formatMessage({ id: "AdvancedSearch" })}</h3>
            ...
            <div className='row mb-8'>
              ...
              <div className='col-6'>
                ...
                >
                  <option value='days'>   {intl.formatMessage({ id: "Days" })}</option>
                  <option value='weeks'>   {intl.formatMessage({ id: "Weeks" })}</option>
                  <option value='months'>   {intl.formatMessage({ id: "Months" })}</option>
                  <option value='years'>   {intl.formatMessage({ id: "Years" })}</option>
                </select>
              </div>
            </div>
          ...
          <form className={`pt-1 ${menuState === 'preferences' ? '' : 'd-none'}`}>
            <h3 className='fw-bold text-dark mb-7'>{intl.formatMessage({ id: "SearchPreferences" })}</h3>
            ...
            <div className='d-flex justify-content-end pt-7'>
              ...
              <button className='btn btn-sm fw-bolder btn-primary'>{intl.formatMessage({ id: "SaveChanges" })}</button>
            </div>
          </form>
        </div>
      </div>
