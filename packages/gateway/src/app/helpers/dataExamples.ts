...
const defaultLogs: Array<LogModel> = [
  { code: 'Recieved Done', state: 'success', message: 'request Id', time: 'Just now'},
  { code: 'Rejected', state: 'danger', message: 'request Id', time: '2 hrs'},
  { code: 'Finished', state: 'success', message: 'request Id', time: '5 hrs'},
  { code: 'Under Processing', state: 'warning', message: 'request Id', time: '2 days'},
]
