...
type KnowledgeGeneralKnowledgeToolbarProps = {
   title?: string;
};

const KnowledgeGeneralKnowledgeToolbar: FC<
   KnowledgeGeneralKnowledgeToolbarProps
               ...
               <div className="page-title d-flex flex-column me-3">
                  ...
                  <ul className="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-3">
                     ...
                     <li className="breadcrumb-item text-white opacity-75">
                        {title !== "GeneralKnowledge" ? (
                           <Link
                              to="/knowledge-general-knowledge"
                              className="text-white text-hover-primary"
                           >
                              {intl.formatMessage({ id: "GeneralKnowledge" })}
                           </Link>
                        ) : (
                           intl.formatMessage({ id: "GeneralKnowledge" })
                        )}
...
export { KnowledgeGeneralKnowledgeToolbar };
