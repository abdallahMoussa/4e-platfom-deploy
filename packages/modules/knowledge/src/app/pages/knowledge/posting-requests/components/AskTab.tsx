...
const AskTab: React.FC<Iprop> = ({ allRequestsData }) => {
  let intl = useIntl();
        ...
        <nav className="mt-4 pt-2">
          ...
          >
            <button
              ...
              data-bs-toggle="tab"
              data-bs-target="#nav_ask_requests"
              type="button"
              role="tab"
            ...
            <button
              ...
              data-bs-toggle="tab"
              data-bs-target="#nav_ask_suspended"
              type="button"
              role="tab"
            ...
            <button
              ...
              id="nav-approved-tab"
              data-bs-toggle="tab"
              data-bs-target="#nav_ask_approved"
              type="button"
              role="tab"
            ...
            <button
              ...
              id="nav-rejected-tab"
              data-bs-toggle="tab"
              data-bs-target="#nav_ask_rejected"
              type="button"
              role="tab"
            ...
            {allRequestsData?.slice(0, visibleItems).map((item) => {
              ...
              return (
                <Fragment key={Math.random()}>
                  <Link
                    to={{
                      pathname: `/knowledge-posting-requests/ask/${id}/details`,
                    }}
                    state={status}
                  >
