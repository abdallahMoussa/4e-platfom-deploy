...
const IdeasBankTab: React.FC<Iprop> = ({ allRequestsData }) => {
  let intl = useIntl();
  ...
  return (
    <Fragment>
      <div
        ...
        id="pills-ideasBank"
        role="tabpanel"
        aria-labelledby="pills-ideasBank-tab"
      >
        <nav className="mt-4 pt-2">
          <div
            className="nav border-0 nav-tabs mb-1 justify-content-center justify-content-md-start "
            id="nav-tab"
            role="tablist"
          >
            <button
              className="btn rounded-0 active fs-6 bg-transparent btn-active-color-primary border-0 ms-6 pe-3 fw-bolder  border border-bottom border-white border-2 border-active-primary"
              id="nav-requestes-tab"
              data-bs-toggle="tab"
              data-bs-target="#nav_ideasBank_requests"
              type="button"
              role="tab"
            ...
            <button
              ...
              data-bs-toggle="tab"
              data-bs-target="#nav_ideasBank_suspended"
              type="button"
              role="tab"
            ...
            <button
              ...
              id="nav-approved-tab"
              data-bs-toggle="tab"
              data-bs-target="#nav_ideasBank_approved"
              type="button"
              role="tab"
            ...
            <button
              ...
              id="nav-rejected-tab"
              data-bs-toggle="tab"
              data-bs-target="#nav_ideasBank_rejected"
              type="button"
              role="tab"
            ...
            {allRequestsData?.slice(0, visibleItems).map((item) => {
              ...
              return (
                <Fragment key={Math.random()}>
                  <Link
                    to={{
                      pathname: `/knowledge-posting-requests/ideasbank/${id}/details`,
                    }}
                    state={status}
                  >
