...
import AddQuestionResponsePopup from "../popup/add-question-reponse-popup";
      ...
      <div className="card-body">
        <div className="d-flex justify-content-start">
          <div className="card-header p-4 d-flex flex-column w-100 border-0 mb-4 mb-md-4">
              ...
              <div className="d-flex justify-content-between align-items-start">
                ...
                <div className="px-4 py-3 d-flex flex-column bg-light mx-2 rounded-2">
                  ...
                  <div className="text-gray-500">
                    ...
                    مع إصدار رقائق "ليتراسيت" (Letraset) البلاستيكية تحوي مقاطع
                    من هذا النص، وعاد لينتشر مرة أخرى مؤخراَ مع ظهور برامج النشر
                    الإلكتروني مثل "ألدوس بايج مايكر" (Aldus PageMaker) والتي
            ...
            <div className="mb-3">
              {intl.formatMessage({ id: "WriteResponse" })}
            </div>
            <div className="d-flex align-items-start">
              ...
              >
                <textarea
                  ...
                  rows={2}
                  placeholder={intl.formatMessage({ id: "WriteResponse" })}
                ></textarea>
                <div
            ...
            <div
              ...
              onClick={handleShow}
              className="d-flex justify-content-center align-items-center border border-primary text-primary mt-10 cursor-pointer p-3 rounded fs-5 fw-bolder"
            >
              <i className="fa-sharp fa-regular fa-plus border border-primary p-1 fw-bolder rounded mx-2"></i>
              {intl.formatMessage({ id: "AddResponse" })}
            </div>

            <AddQuestionResponsePopup handleClose={handleClose} show={show} />
          </div>
        </div>
      </div>
    </div>
