...
const KnowledgeAskExpertToolbar: FC = () => {
  const intl = useIntl()
    ...
    <div className="toolbar py-5 py-lg-15" id="kt_toolbar">
      <div id="kt_toolbar_container" className="container-xxl d-flex flex-stack flex-wrap p-0">
        <div className="page-title d-flex flex-column me-3">
          <h1 className="d-flex text-white fw-bolder my-1 fs-3">{intl.formatMessage({ id: "AskExpert" })}</h1>
...
export { KnowledgeAskExpertToolbar }
