...
import { IdeasComment } from "./IdeaComment";
        ...
        <div className="d-flex justify-content-start">
          <div className="card-header p-4 d-flex flex-column w-100 border-0 mb-4 mb-md-5">
            <div className="d-flex justify-content-between align-items-center">
              ...
              <div>
                <div className="badge badge-success">200 {intl.formatMessage({ id: "Supporter" })}</div>
              </div>
            </div>
            <div className="mt-2 w-100 pb-2 mb-5">
              <div className="py-1">
                <div className="pt-2">
            ...
            <ul className="nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6 p-0">
              <li className="nav-item">
                <a
                  className="nav-link active"
                  data-bs-toggle="tab"
                  href="#kt_tab_pane_comments"
                >
            ...
            <div className="tab-content" id="myTabContent">
              ...
              >
                <div>
                  ...
                  <div className="d-flex border-top mt-3">
