...
const KnowledgeWorkSpace: FC = () => {
  const intl = useIntl();
  const [getCardsList, setCardsList] = useState([
    //Knowledge - My Tools
    {
      id: 1,
      name: intl.formatMessage({ id: "KnowledgeManagement" }),
      dept: intl.formatMessage({ id: "ResearchAndStudies" }),
      title: intl.formatMessage({ id: "AskExpert" }),
      icon: <i className="bi bi-person-video3 fs-3x"></i>,
      subIcon: <i className="bi bi-tools"></i>,
      subTitle: intl.formatMessage({ id: "ReviewAndQuestionTheExpert" }),
      count: "",
    ...
    },
    {
      ...
      icon: <i className="bi bi-lightbulb fs-3x"></i>,
      subIcon: <i className="bi bi-tools"></i>,
      subTitle: intl.formatMessage({ id: "IdeasReview" }),
      count: "",
      lastUpdate: "20/04/2022",
      lastLogin: "20/04/2022",
      link: "/knowledge-ideas-bank",
    ...
    },
    {
      ...
      name: intl.formatMessage({ id: "KnowledgeManagement" }),
      dept: intl.formatMessage({ id: "ResearchAndStudies" }),
      title: intl.formatMessage({ id: "AskChallenge" }),
      icon: <i className="fad fa-exclamation-triangle fs-3x"></i>,
      subIcon: <i className="bi bi-tools"></i>,
      subTitle: intl.formatMessage({ id: "ReviewAndPresentNewChallenges" }),
      count: "",
      lastUpdate: "20/07/2022",
      lastLogin: "30/08/2022",
      link: "/knowledge-ask-challenge",
    ...
    },
    {
      ...
      name: intl.formatMessage({ id: "KnowledgeManagement" }),
      dept: intl.formatMessage({ id: "ResearchAndStudies" }),
      title: intl.formatMessage({ id: "Blogging" }),
      icon: <i className="bi bi-chat-text fs-3x"></i>,
      subIcon: <i className="bi bi-tools"></i>,
      subTitle: intl.formatMessage({ id: "BlogReviews" }),
      count: "",
      lastUpdate: "22/04/2022",
      lastLogin: "23/04/2022",
      link: "/knowledge-blogging",
      color: "svg-icon-success",
      background: "bg-light-success",
      isShow: true,
    },
    {
      ...
      name: intl.formatMessage({ id: "KnowledgeManagement" }),
      dept: intl.formatMessage({ id: "ResearchAndStudies" }),
      title: intl.formatMessage({ id: "GeneralKnowledge" }),
      icon: <i className="fas fa-folder-open fs-3x"></i>,
      subIcon: <i className="bi bi-tools"></i>,
      subTitle: intl.formatMessage({ id: "ShowOwnknowledge" }),
      count: "",
      lastUpdate: "15/06/2022",
      lastLogin: "20/06/2022",
      link: "/knowledge-general-knowledge",
      color: "svg-icon-warning",
      background: "bg-light-warning",
      isShow: true,
    },
    {
      ...
      name: intl.formatMessage({ id: "KnowledgeManagement" }),
      dept: intl.formatMessage({ id: "ResearchAndStudies" }),
      title: intl.formatMessage({ id: "OwnKnowledge" }),
      icon: <i className="fas fa-folder fs-3x"></i>,
      subIcon: <i className="bi bi-tools"></i>,
      subTitle: intl.formatMessage({ id: "ShowGeneralknowledge" }),
      count: "",
      lastUpdate: "23/07/2022",
      lastLogin: "20/04/2022",
      link: "/knowledge-own-knowledge",
    ...
    },
    {
      ...
      name: intl.formatMessage({ id: "KnowledgeManagement" }),
      dept: intl.formatMessage({ id: "ResearchAndStudies" }),
      title: intl.formatMessage({ id: "PostingRequests" }),
      icon: <i className="bi bi-stickies-fill fs-3x"></i>,
      subIcon: <i className="bi bi-tools"></i>,
      subTitle: intl.formatMessage({ id: "ReviewingAndApprovingRequests" }),
      count: "",
      lastUpdate: "15/04/2022",
      lastLogin: "29/04/2022",
      link: "/knowledge-posting-requests",
    ...
    },
    {
      ...
      name: intl.formatMessage({ id: "KnowledgeManagement" }),
      dept: intl.formatMessage({ id: "ResearchAndStudies" }),
      title: intl.formatMessage({ id: "MyQuestions" }),
      icon: <i className="bi bi-question-circle-fill fs-3x"></i>,
      subIcon: <i className="bi bi-tools"></i>,
      subTitle: intl.formatMessage({ id: "ViewExpertQuestions" }),
      count: "",
      lastUpdate: "02/12/2022",
      lastLogin: "30/12/2022",
      link: "/knowledge-my-questions",
      color: "svg-icon-success",
      background: "bg-light-success",
      isShow: true,
    },
    {
      ...
      name: intl.formatMessage({ id: "KnowledgeManagement" }),
      dept: intl.formatMessage({ id: "ResearchAndStudies" }),
      title: intl.formatMessage({ id: "Experts" }),
      icon: <i className="fad fa-chalkboard-teacher fs-3x"></i>,
      subIcon: <i className="bi bi-tools"></i>,
      subTitle: intl.formatMessage({ id: "ExpertsCounts" }),
      count: ": 15",
      lastUpdate: "22/04/2022",
      lastLogin: "23/04/2022",
      link: "/knowledge-experts",
      color: "svg-icon-info",
    ...
    //Important Note :Knowledge Shared Services is same as Knowledge My Tools
  ...
  const [getTableList, setTableList] = useState([
    ...
    },
    {
      ...
      dept: intl.formatMessage({ id: "ResearchAndStudies" }),
      title: intl.formatMessage({ id: "Blogging" }),
      icon: <i className="bi bi-chat-text fs-2x"></i>,
      subIcon: <i className="bi bi-tools"></i>,
      subTitle: intl.formatMessage({ id: "BlogReviews" }),
      count: "",
      lastUpdate: "22/04/2022",
    ...
    },
    {
      ...
      dept: intl.formatMessage({ id: "ResearchAndStudies" }),
      title: intl.formatMessage({ id: "GeneralKnowledge" }),
      icon: <i className="fas fa-folder-open fs-2x"></i>,
      subIcon: <i className="bi bi-tools"></i>,
      subTitle: intl.formatMessage({ id: "ShowOwnknowledge" }),
      count: "",
      lastUpdate: "15/06/2022",
    ...
    },
    {
      ...
      dept: intl.formatMessage({ id: "ResearchAndStudies" }),
      title: intl.formatMessage({ id: "OwnKnowledge" }),
      icon: <i className="fas fa-folder fs-2x"></i>,
      subIcon: <i className="bi bi-tools"></i>,
      subTitle: intl.formatMessage({ id: "ShowGeneralknowledge" }),
      count: "",
      lastUpdate: "23/07/2022",
    ...
    },
    {
      ...
      dept: intl.formatMessage({ id: "ResearchAndStudies" }),
      title: intl.formatMessage({ id: "PostingRequests" }),
      icon: <i className="bi bi-stickies-fill fs-2x"></i>,
      subIcon: <i className="bi bi-tools"></i>,
      subTitle: intl.formatMessage({ id: "ReviewingAndApprovingRequests" }),
      count: "",
      lastUpdate: "15/04/2022",
    ...
    },
    {
      ...
      dept: intl.formatMessage({ id: "ResearchAndStudies" }),
      title: intl.formatMessage({ id: "MyQuestions" }),
      icon: <i className="bi bi-question-circle-fill fs-2x"></i>,
      subIcon: <i className="bi bi-tools"></i>,
      subTitle: intl.formatMessage({ id: "ViewExpertQuestions" }),
      count: "",
      lastUpdate: "02/12/2022",
    ...
    },
    {
      ...
      dept: intl.formatMessage({ id: "ResearchAndStudies" }),
      title: intl.formatMessage({ id: "Experts" }),
      icon: <i className="fad fa-chalkboard-teacher fs-2x"></i>,
      subIcon: <i className="bi bi-tools"></i>,
      subTitle: intl.formatMessage({ id: "ExpertsCounts" }),
      count: "15",
      lastUpdate: "22/04/2022",
    ...
    //Knowledge Shared Services is same as Knowledge My Tools
