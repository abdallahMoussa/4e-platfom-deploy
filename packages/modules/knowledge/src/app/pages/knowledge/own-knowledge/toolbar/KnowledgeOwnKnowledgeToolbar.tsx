...
type KnowledgeOwnKnowledgeToolbarProps = {
   title?: string;
};

const KnowledgeOwnKnowledgeToolbar: FC<KnowledgeOwnKnowledgeToolbarProps> = ({
   title = "OwnKnowledge",
}) => {
   const intl = useIntl();
   return (
                     ...
                     <li className="breadcrumb-item text-white opacity-75">
                        {title !== "OwnKnowledge" ? (
                           <Link
                              ...
                              className="text-white text-hover-primary"
                           >
                              {intl.formatMessage({ id: "OwnKnowledge" })}
                           </Link>
                        ) : (
                           intl.formatMessage({ id: "OwnKnowledge" })
                        )}
...
export { KnowledgeOwnKnowledgeToolbar };
