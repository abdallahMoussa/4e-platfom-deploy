...
import { KnowledgeOwnKnowledgeableContentToolbar } from "./toolbar/KnowledgeOwnKnowledgeableContentToolbar";

export const KnowledgeOwnKnowledgeableContent: FC = () => {
   const intl = useIntl();
   ...
   return (
      <>
         <KnowledgeOwnKnowledgeableContentToolbar />
         <RightToolbar />
