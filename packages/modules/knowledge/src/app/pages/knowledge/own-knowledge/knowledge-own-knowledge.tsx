...
const KnowledgeOwnKnowledge: FC = () => {
  const intl = useIntl();
  ...
  return (
    <>
      <div className="d-flex justify-content-between align-items-center">
        <div>
          <KnowledgeOwnKnowledgeToolbar />
          <RightToolbar />
        </div>
        <div>
          <Link
            to="/knowledge-own-knowledge/add-new"
                ...
                {knowledgeData.map((item) => (
                  <div className="col-12 col-sm-6 col-md-3">
                    <div
                      ...
                      onClick={() => navigate("/knowledge-own-knowledge/list")}
                      role="button"
                    >
