...
import { KnowledgeOwnKnowledgeListToolbar } from "./toolbar/KnowledgeOwnKnowledgeListToolbar";

const EN_LANG = "en";

export const KnowledgeOwnKnowledgeList: FC = () => {
  ...
  const [knowledge, setKnowledge] = useState([
    {
      id: 1,
      date: "11 مارس 2023",
      title: `تطوير منظومه المساهمات العقارية واستحداث تنظيم
         جديد للمساهمات العقارية`,
      description: `تطوير منظومه المساهمات العقارية واستحداث تنظيم جديد للمساهمات العقارية",
  ...
  return (
    <>
      <div className="d-flex justify-content-between align-items-center">
        <div>
          <KnowledgeOwnKnowledgeListToolbar title="KnowledgeList" />
          <RightToolbar />
        </div>
        <div>
          <Link
            to="/knowledge-own-knowledge/list/add"
              ...
              <div className="row card-body py-8">
                {knowledge.map((item) => (
                  ...
                  >
                    ...
                    <Link
                      to="/knowledge-own-knowledge/list/1"
                    ...
                    <div className="row d-flex align-items-center justify-content-between my-5">
                      ...
                      <div className="col-lg-8 col-md-8 col-sm-6 col-12 d-flex justify-content-between flex-wrap mt-2 gap-2 ">
                        {item.stats.map((stat) => (
                          <span
                            className="mb-0 border border-1 rounded p-3"
                            role="button"
