...
import AddChallengePopup from "../popup/add-challenge-popup";

const KnowledgeAskChallengeToolbar: FC = () => {
  const intl = useIntl();
        ...
        >
          <div className="page-title d-flex flex-column me-3">
            <h1 className="d-flex text-white fw-bolder my-1 fs-3">
              {intl.formatMessage({ id: "ListOfChallenges" })}
            </h1>
          ...
          <div
            ...
            aria-hidden="true"
          >
            <AddChallengePopup handleClose={handleClose} show={show} />
          </div>
        </div>
      </div>
    </>
...
export { KnowledgeAskChallengeToolbar };
