...
import FilterChallangesPopup from "../popup/filter-Challenges-popup";
          ...
          <h3 className="card-title align-items-start flex-column">
            <span className="card-label fw-bold fs-4 mb-3 ">
              <span className="fw-normal">
                {intl.formatMessage({ id: "ProblemsChallenges" })}
              </span>
            </span>
            <span className="mt-1 fw-semibold fs-6 text-muted">
              {intl.formatMessage({ id: "ChallengesProblemsTable" })}
            </span>
          </h3>
          <div className="card-toolbar outputCard card-diff-toolbar">
            <div className="d-flex justify-content-between align-items-center mt-3 mt-lg-0 justify-content-lg-end">
              <div
                ...
                // data-bs-target="#Rega_modal_filter-challanges"
                onClick={(event) => {
                    ...
                    {Array.from({ length: 4 }).map((_, index) => (
                      <tr key={index} className="h-60px">
                        <td className="d-flex align-items-center justify-content-center">
                          <Link to={"/pmo-project-challenges-details"}>
