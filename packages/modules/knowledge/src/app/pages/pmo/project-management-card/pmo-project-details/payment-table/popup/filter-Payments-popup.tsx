...
const FilterPaymentsPopup: React.FC<PopupProps> = ({ show, handleClose }) => {
  const intl = useIntl();
              ...
              <div className="container">
                <div className="row g-5">
                  <div className="col-4">
                    ...
                    <CheckBoxDropDown
                      selectedOptions={paymentName}
                      setSelectedOptions={setPaymentName}
                      options={optionsOne}
                    />
                  </div>
                  <div className="col-4">
                  ...
                  <div className="col-4">
                    <label className="form-label px-2  fs-6 text-gray-700">
                      {intl.formatMessage({ id: "PaymentDate" })}
                    </label>
                    <input
                      type="date"
...
export default FilterPaymentsPopup;
