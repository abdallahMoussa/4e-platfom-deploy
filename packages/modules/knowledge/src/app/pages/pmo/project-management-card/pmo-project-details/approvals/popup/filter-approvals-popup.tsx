...
const FilterApprovalsPopup: React.FC<PopupProps> = ({ show, handleClose }) => {
  const intl = useIntl();
  ...
  return (
    <Fragment>
      {/* <div
        ...
        id="rega_modal_filter_approvals"
        aria-hidden="true"
      >
              ...
              <div className="col-6">
                <div className="mb-2 pt-2 pb-3 ">
                  ...
                  <div className="mx-auto mt-1  ">
                    <CheckBoxDropDown
                      selectedOptions={requestName}
                      setSelectedOptions={setRequestName}
                      options={optionsTwo}
                    />
                  </div>
                </div>
...
export default FilterApprovalsPopup;
