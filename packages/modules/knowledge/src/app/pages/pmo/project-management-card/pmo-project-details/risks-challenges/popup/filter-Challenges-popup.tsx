...
const FilterChallengesPopup: React.FC<PopupProps> = ({ show, handleClose }) => {
  const intl = useIntl();
  ...
  return (
    <>
      {/* <div
        ...
        id="Rega_modal_filter-challanges"
        aria-hidden="true"
      >
            ...
            <div className="mb-15 mt-15">
              <div className="container">
                <div className="row g-5">
                  <div className="col-4">
                    <label className="form-label px-2  fs-6 text-gray-700">
                      {intl.formatMessage({ id: "ChallengeRange" })}
                    </label>
                    <CheckBoxDropDown
                  ...
                  <div className="col-4">
                    <label className="form-label px-2  fs-6 text-gray-700">
                      {" "}
                      {intl.formatMessage({ id: "ChallengeEffect" })}{" "}
                    </label>
                    <CheckBoxDropDown
...
export default FilterChallengesPopup;
