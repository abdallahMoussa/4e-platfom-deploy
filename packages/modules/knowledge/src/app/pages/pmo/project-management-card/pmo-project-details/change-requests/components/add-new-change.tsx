        ...
        <div className="card-header px-3 pdt-3 pb-2 mb-3">
          <h3 className="card-title align-items-start flex-column my-10 mx-5">
            <span className="card-label fs-4 mb-2 ">
              {intl.formatMessage({ id: "AddNewChange" })}{" "}
            </span>
                ...
                <div className="row">
                  ...
                  <div className="table-responsive my-10">
                    <table className="table table-rounded border  table-row-gray-200 align-middle gs-0 gy-4 text-center">
                      ...
                      <tbody>
                        <tr className="h-60px">
                          <td> {intl.formatMessage({ id: "CostRatio" })}</td>
                          <td> {intl.formatMessage({ id: "TimeRatio" })} </td>
                          <td> {intl.formatMessage({ id: "NO" })}</td>
                          <td> {intl.formatMessage({ id: "NO" })}</td>
                          <td> {intl.formatMessage({ id: "NO" })}</td>
                        </tr>
                      </tbody>
