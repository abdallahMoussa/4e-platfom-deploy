      ...
      title: (
        <Fragment>
          ...
          >
            ...
            >
              <span>40%</span>
              <label>{intl.formatMessage({ id: "InterfaceDesign" })}</label>
            </div>
          </div>
        </Fragment>
      ),
      ...
      title: (
        <Fragment>
          <div
            ...
            style={{ backgroundColor: "#009EF7", height: "22px" }}
          >
            <div
              className="progress-bar  px-2"
              role="progressbar"
        ...
        <TimelineHeaders>
          <SidebarHeader
            headerData={{
              ...
              subtitle: intl.formatMessage({ id: "14Month" }),
            }}
          >
            {({ getRootProps, data }) => {
              return (
              ...
              return (
                <div {...getIntervalProps()} className="h-100">
                  <p
                    ...
                    style={{ backgroundColor: "#F5F8FA", fontSize: "11px" }}
                  >
                    {intl.formatMessage({ id: intervalContext.intervalText })}
                  </p>
                </div>
