...
const FilterLessonsLearnedPopup: React.FC<PopupProps> = ({
  show,
  handleClose,
}) => {
  const intl = useIntl();
  ...
  return (
    <Fragment>
      {/* <div
        ...
        id="rega_modal_filter_lessons-learned"
        aria-hidden="true"
      >
              ...
              <div className="col-6">
                <div className="mb-2 pt-2 pb-3 ">
                  ...
                  <div className="mx-auto mt-1  ">
                    <CheckBoxDropDown
                      selectedOptions={lessonAddress}
                      setSelectedOptions={setLessonAddress}
                      options={optionsOne}
                    />
                  </div>
                </div>
...
export default FilterLessonsLearnedPopup;
