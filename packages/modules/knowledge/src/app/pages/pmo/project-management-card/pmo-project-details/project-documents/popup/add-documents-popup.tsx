...
const AddDocumentPopup: React.FC<PopupProps> = ({ show, handleClose }) => {
  const intl = useIntl();

  const [documentName, setDocumentName] = useState(false);

  const handleDocumentName = (e: ChangeEvent<HTMLSelectElement>) => {
              ...
              <div className="container">
                <div className="row g-5">
                  <div className="col-6">
                    ...
                    >
                      <option>العقد</option>
                      <option>التعميد</option>
                      <option>كراسة الشروط</option>
                      <option>العرض المالي</option>
                      <option>العرض الفنى</option>
                      <option
                        value="others"
                        {...(documentName ? { selected: true } : {})}
                      >
                        اخرى
                      </option>
                    </select>
                  ...
                  <div className="row">
                    <div className="mb-2 pt-4 pb-3 ">
                      <label className="form-label px-2  fontSz-6 text-gray-700  mb-4">
