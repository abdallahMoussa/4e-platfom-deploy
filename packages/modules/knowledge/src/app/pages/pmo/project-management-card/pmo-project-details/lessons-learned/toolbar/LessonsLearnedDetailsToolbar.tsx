...
const LessonsLearnedDetailsToolbar: FC = () => {
  const intl = useIntl();
        ...
        >
          <div className="page-title d-flex flex-column me-3">
            <h1 className="d-flex text-white fw-bolder my-1 fs-3 mb-5">
              {" "}
              {intl.formatMessage({ id: "ViewTheDetailsOfTheLessonLearned" })}
            </h1>
            <ul className="breadcrumb breadcrumb-separatorless fw-bold fs-7">
              ...
              <li className="breadcrumb-item text-white opacity-75">
                {" "}
                {intl.formatMessage({ id: "LessonDetails" })}
              </li>
            </ul>
          </div>
...
export { LessonsLearnedDetailsToolbar };
