...
const PmoProblemsChallengesToolbar: FC = () => {
  // return <>
  //   <div className="toolbar py-5 py-lg-15" id="kt_toolbar">
  //     <div id="kt_toolbar_container" className="container-xxl d-flex flex-stack flex-wrap p-0">
  //       <div className="page-title d-flex flex-column me-3">
  //         <h1 className="d-flex text-white fw-bolder my-1 fs-3">المشاكل والتحديات</h1>
  //       </div>
  ...
  return <>
    <div className="toolbar py-5 py-lg-15" id="kt_toolbar">
      <div id="kt_toolbar_container" className="container-xxl d-flex flex-stack flex-wrap p-0">
        <div className="page-title d-flex flex-column me-3">
          <h1 className="d-flex text-white fw-bolder my-1 fs-3">{intl.formatMessage({ id: "ProblemsAndChallenges" })}</h1>
          <ul className="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
              ...
              <li className="breadcrumb-item">
                <span className="bullet bg-white opacity-75 w-5px h-2px text-hover-primary"></span>
              </li>
              <span
                className="breadcrumb-item text-white opacity-75"
              >
                {intl.formatMessage({ id: "ProblemsAndChallenges" })}
              </span>
            </ul>
        </div>
        <div className="d-flex align-items-center py-3 py-md-1"></div>
...
export { PmoProblemsChallengesToolbar }
