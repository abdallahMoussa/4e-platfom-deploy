...
const FilterRisksPopup: FC<PopupProps> = ({ show, handleClose }) => {
  const intl = useIntl();
  ...
  return (
    // <div className="modal fade creatForm" id="Rega_modal_filter-risks" tabIndex={-1} aria-hidden="true">
    ...
    >
      <div className="card scroll-y">
        ...
        >
          <div className="card-header mt-10 d-flex justify-content-center align-items-center text-center w-100 px-4 border-bottom-0">
            ...
            <div className="container">
              <div className="row g-10">
                ...
                <div className="col-4">
                  ...
                  <CheckBoxDropDown
                    selectedOptions={problemNum}
                    setSelectedOptions={setProblemNum}
                    options={optionsFour}
                  />
                </div>
              </div>
        ...
        <Modal.Footer className="justify-content-center pb-12 pt-3 border-top-0">
