...
export const EditFinesCalculationMechanismPopup: FC<
          ...
          <form noValidate className="form outputForm">
            <div className="row">
              <div className="col-lg-6 mb-2 pt-2 pb-3">
                ...
                >
                  {intl.formatMessage({ id: "FineCalculationMechanism" })}
                </label>
                <div className="input-group">
                  ...
                  <input
                    ...
                    name="fineCalculationMechanism"
                    value={inputData.fineCalculationMechanism}
              ...
              <div className="col-lg-6 mb-2 pt-2 pb-3">
                ...
                <div className="input-group">
                  ...
                  <input
                    ...
                    type="text"
                    className="form-control"
                    placeholder={intl.formatMessage({ id: "FinePercentage" })}
                    name="finePercentage"
                    value={inputData.finePercentage}
                    onChange={handleChange}
                  />
                </div>
              </div>
