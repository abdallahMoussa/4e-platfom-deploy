...
import { TechnicalDefinitionsActions } from "./technical-definitions-actions";

export const TechnicalDefinitions: FC = () => {
  ...
  //     ['1', 'الحهه الحكوميه', 'المركز الوطني لتنميه الغطاء النباتي ومكافحه التصحر'],
  // ['2', 'المتنافس', ' الوطني لتنميه الغطاء'],
  // ['3', 'النظام', ' الوطني لتنميه الغطاء النباتي ومكافحه التصحر'],
  // ['4', 'الائحه التنفيذيه', ' الوطني لتنميه مكافحه التصحر'],
  // 'M', 'Term', 'TheDefinition'
  const [items, setItems] = useState([
    {
      id: 1,
      m: 1,
      term: "الحهه الحكوميه",
      theDefinition: "المركز الوطني لتنميه الغطاء النباتي ومكافحه التصحر",
    },
    {
      id: 2,
      m: 2,
      term: "المتنافس",
      theDefinition: "الوطني لتنميه الغطاء",
    },
    {
      id: 3,
      m: 3,
      term: "النظام",
      theDefinition: " الوطني لتنميه الغطاء النباتي ومكافحه التصحر",
    },
    {
      id: 4,
      m: 4,
      term: "الائحه التنفيذيه",
      theDefinition: " الوطني لتنميه مكافحه التصحر",
    },
  ]);
      ...
      >
        <div className="content flex-row-fluid" id="kt_content">
          <div className="d-flex flex-column flex-lg-row">
            <NewFeasibilityStudySidebar card_number={"10"} page_size={786} />
                ...
                <div className="card-header border-1 pt-3 pb-2 d-flex flex-stack flex-wrap">
                  <h3 className="card-title align-items-start d-flex flex-column">
                    <h2 className="text-dark mb-2 fs-3 mt-3">
                      {intl.formatMessage({ id: "TechnicalDefinitions" })}
                    </h2>
                    <span className="text-muted fs-7">
                      {intl.formatMessage({
                        id: "TermsAndTheirDefinitionSeparately",
                      })}
                    </span>
                  </h3>
                    ...
                    >
                      <form noValidate className="form outputForm">
                        <div className="row">
                          ...
                          >
                            <i className="w-100 text-center fa-solid fa-plus text-success py-4 px-4 border rounded border-dashed border-success rounded border-2 fw-bolder fs-4 border-1">
                              {" "}
                            </i>
                          </div>
                          <div className="col-lg-12 mb-2 mt-12 pb-3">
                            <CreateProjectTable
                              ...
                              ActionComponent={TechnicalDefinitionsActions}
                            />
                          </div>
                        </div>
