...
import { EditAccessoriesPopup } from "../popup/edit-accessories-popup";
...
export const AccessoriesActions: FC<ActionProps> = ({ data, handleEdit }) => {
  const intl = useIntl();
  ...
  return (
    <>
          ...
          >
            <div className="menu-item px-3">
              <a
                ...
                //  data-bs-target={`#Rega_modal_edit_accessories${data.id}`}
      ...
      <div
        ...
        id={`Rega_modal_edit_accessories${data.id}`}
        tabIndex={-1}
        aria-hidden="true"
      >
        <EditAccessoriesPopup
          data={data}
