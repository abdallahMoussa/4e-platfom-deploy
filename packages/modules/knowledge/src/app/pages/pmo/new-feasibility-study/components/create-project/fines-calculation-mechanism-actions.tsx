...
import { EditFinesCalculationMechanismPopup } from "../popup/edit-fines-calculation-mechanism-popup";
...
export const FinesCalculationMechanismActions: FC<ActionProps> = ({
  data,
  handleEdit,
}) => {
  ...
  return (
    <>
          ...
          >
            <div className="menu-item px-3">
              <a
                ...
                //  data-bs-target={`#Rega_modal_edit_fines_calculation_mechanism${data.id}`}
      ...
      <div
        ...
        id={`Rega_modal_edit_fines_calculation_mechanism${data.id}`}
        tabIndex={-1}
        aria-hidden="true"
      >
        <EditFinesCalculationMechanismPopup
          data={data}
