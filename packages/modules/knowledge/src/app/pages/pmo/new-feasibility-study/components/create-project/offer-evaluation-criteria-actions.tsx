...
import { EditOfferEvaluationCriteriaPopup } from "../popup/edit-offer-evaluation-criteria-popup";
...
export const OfferEvaluationCriteriaActions: FC<ActionProps> = ({
  data,
  handleEdit,
}) => {
  const intl = useIntl();
  ...
  return (
    <>
          ...
          >
            <div className="menu-item px-3">
              <a
                ...
                //  data-bs-target={`#Rega_modal_edit_offer_evaluation_criteria${data.id}`}
      ...
      <div
        ...
        id={`Rega_modal_edit_offer_evaluation_criteria${data.id}`}
        tabIndex={-1}
        aria-hidden="true"
      >
        <EditOfferEvaluationCriteriaPopup
          data={data}
