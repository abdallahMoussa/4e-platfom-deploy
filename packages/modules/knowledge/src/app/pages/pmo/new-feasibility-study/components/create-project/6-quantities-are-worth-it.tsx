...
import { FeasibilityStudyActions } from "./feasibility-study-actions";

export const QuantitiesAreWorthIt: FC = () => {
  ...
  const [tableData, setTableData] = useState([
    {
      id: 1,
      clause: "اتمتة العمليات",
      specifications: "المواصفات",
      measuringUnit: "وحده القياس",
      quantity: "الكميه",
      mandatoryList: "نعم",
      productCategoryCode: "رمز فئة المتنج",
      isMandatoryListChecked: true,
    },
    {
      id: 2,
      clause: "اتمتة العمليات",
      ...
      >
        <div className="content flex-row-fluid" id="kt_content">
          <div className="d-flex flex-column flex-lg-row">
            <NewFeasibilityStudySidebar card_number={"6"} page_size={882} />
                ...
                <div className="card-header border-1 pt-3 pb-2 d-flex flex-stack flex-wrap">
                  <h3 className="card-title align-items-start d-flex flex-column">
                    <h2 className="text-dark mb-2 fs-3 mt-3">
                      {intl.formatMessage({ id: "QuantitiesAreWorthIt" })}
                    </h2>
                    <span className="text-muted fs-7">
                      {intl.formatMessage({ id: "SuppliesToBeUsed" })}
                    </span>
                  </h3>
                        ...
                        <div className="row">
                            ...
                            <div className="input-group">
                              <div className="input-group-prepend">
                                <span className="input-group-text">
                                  <i className="special bi bi-aspect-ratio"></i>
                                </span>
                              </div>
                          ...
                          <div className="col-lg-6 mb-2 pt-2 pb-3">
                            ...
                            <div className="input-group">
                              <div className="input-group-prepend">
                                <span className="input-group-text">
                                  <i className="special fas fa-ruler-combined"></i>
                                </span>
                              </div>
                          ...
                          <div className="col-lg-6 mb-2 pt-2 pb-3">
                            ...
                            <div className="input-group">
                              <div className="input-group-prepend">
                                <span className="input-group-text">
                                  <i className="special bi bi-list-ol"></i>
                                </span>
                              </div>
                          ...
                          <div className="col-lg-12 mb-2 mt-12 pb-3">
                            <CreateProjectTable
                              ...
                              tbody_td_values={tableData}
                              handleEdit={handleEdit}
                              ActionComponent={FeasibilityStudyActions}
                            />
                          </div>
                        </div>
