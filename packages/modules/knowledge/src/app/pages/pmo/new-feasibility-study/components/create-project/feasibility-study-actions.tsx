...
export const FeasibilityStudyActions: FC<ActionProps> = ({
  data,
  handleEdit,
}) => {
  ...
  return (
    <>
          ...
          >
            <div className="menu-item px-3">
              <a
                ...
                // data-bs-target={`#Rega_modal_edit-quantities-are-worth-it${data.id}`}
      ...
      <div
        ...
        id={`Rega_modal_edit-quantities-are-worth-it${data.id}`}
        tabIndex={-1}
        aria-hidden="true"
      >
        <EditQuantitiesAreWorthItPopup
          data={data}
