...
import { MilestonesActions } from "./milestones-actions";
      ...
      >
        <div className="content flex-row-fluid" id="kt_content">
          <div className="d-flex flex-column flex-lg-row">
            <NewFeasibilityStudySidebar card_number={"15"} page_size={665} />
                ...
                <div className="card-header border-1 pt-3 pb-2 d-flex flex-stack flex-wrap">
                  <h3 className="card-title align-items-start d-flex flex-column">
                    <h2 className="text-dark mb-2 fs-3 mt-3">
                      {intl.formatMessage({ id: "Milestones" })}
                    </h2>
                    <span className="text-muted fs-7">
                      {intl.formatMessage({ id: "ProgrammeOfAction" })}
                    </span>
                  </h3>
                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-12 mb-2 mt-12 pb-3">
                            <CreateProjectTable
                              ...
                              ActionComponent={MilestonesActions}
                            />
                          </div>
                        </div>
