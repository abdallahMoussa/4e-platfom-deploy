...
import { TeamWorkSpecificationActions } from "./team-work-specification-actions";

export const TeamWorkSpecification: FC = () => {
      ...
      >
        <div className="content flex-row-fluid" id="kt_content">
          <div className="d-flex flex-column flex-lg-row">
            <NewFeasibilityStudySidebar card_number={"13"} page_size={763} />
                ...
                <div className="card-header border-1 pt-3 pb-2 d-flex flex-stack flex-wrap">
                  <h3 className="card-title align-items-start d-flex flex-column">
                    <h2 className="text-dark mb-2 fs-3 mt-3">
                      {intl.formatMessage({ id: "TeamSpecification" })}
                    </h2>
                    <span className="text-muted fs-7">
                      {intl.formatMessage({ id: "JobDataForTheWorkTeam" })}
                    </span>
                  </h3>
                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-12 mb-2 mt-12 pb-3">
                            <CreateProjectTable
                              ...
                              ActionComponent={TeamWorkSpecificationActions}
                            />
                          </div>
                        </div>
                        <div className="col-12 col-lg-12 mx-auto mb-10">
                          <div className=" card-diff-toolbar w-100 mt-3 d-flex justify-content-center">
                            <div className="d-flex justify-content-center align-items-center w-50">
                              ...
                              <Link
                                to={
                                  "/pmo-new-feasibility-study/fines-calculation-mechanism"
                                }
