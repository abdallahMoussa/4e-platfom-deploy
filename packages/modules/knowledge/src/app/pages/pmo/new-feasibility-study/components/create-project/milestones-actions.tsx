...
import { EditMilestonesPopup } from "../popup/edit-milestones-popup";
...
export const MilestonesActions: FC<ActionProps> = ({ data, handleEdit }) => {
  const intl = useIntl();
  ...
  return (
    <>
          ...
          >
            <div className="menu-item px-3">
              <a
                ...
                //  data-bs-target={`#Rega_modal_edit_milestone${data.id}`}
      ...
      <div
        ...
        id={`Rega_modal_edit_milestone${data.id}`}
        tabIndex={-1}
        aria-hidden="true"
      >
        <EditMilestonesPopup
