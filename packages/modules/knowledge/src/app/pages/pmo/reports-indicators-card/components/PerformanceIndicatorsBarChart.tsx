...
function PerformanceIndicatorsBarChart() {
  const data = [
    { x: "مكتب خبراء النزاعات", y: 15 },
    { x: "مركز التحكيم العقاري", y: 20 },
    ...
    { x: "Law", y: 40 },
    { x: "IT", y: 20 },
    { x: "Exellence Mangement", y: 25 },
    { x: "Enterprise Resource", y: 35 },
    { x: "Cyper security", y: 20 },
    { x: "Communication", y: 6 },
  ];
  return (
    <Fragment>
...
export default PerformanceIndicatorsBarChart;
