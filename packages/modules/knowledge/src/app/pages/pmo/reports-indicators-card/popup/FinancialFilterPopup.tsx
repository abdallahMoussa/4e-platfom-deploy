...
const FinancialFilterPopup: React.FC<PopupProps> = ({ show, handleClose }) => {
  const intl = useIntl();
  ...
  return (
    <Fragment>
      {/* <div
        ...
        id="Rega_modal_filter_financial"
        tabIndex={-1}
        aria-modal="true"
        role="dialog"
      >
              ...
              <Modal.Body className="pb-0 mx-4">
                <div className="row w-100 mb-3">
                  ...
                  <div className="col-4">
                    <div className="mb-2 pt-2 pb-3">
                      <label className="form-label px-2  fs-6 text-gray-700">
                        {intl.formatMessage({ id: "BudgetLine" })}
                      </label>
                      <div className="mx-auto mt-1  ">
                        <CheckBoxDropDown
                          selectedOptions={projectName}
...
export default FinancialFilterPopup;
