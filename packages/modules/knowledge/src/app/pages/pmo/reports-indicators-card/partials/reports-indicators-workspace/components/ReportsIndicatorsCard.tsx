...
const ReportsIndicatorsCard: FC<Iprop> = ({ id, name, dept, title, subTitle, count, lastUpdate, lastLogin, link, icon, subIcon, color, background, isShow }) => {
  const intl = useIntl()
  return (
    <>
      {isShow && <div id={id} className="col-md-4 col-xl-4 col-xxl-3">
        <div className="card">
