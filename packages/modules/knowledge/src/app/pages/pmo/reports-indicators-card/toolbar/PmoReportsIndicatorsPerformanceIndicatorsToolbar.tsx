...
function PmoReportsIndicatorsPerformanceIndicatorsToolbar() {
  let intl = useIntl();
        ...
        <div className="card-toolbar ">
          <div className="d-flex justify-content-between align-items-center mt-3 mt-lg-0 justify-content-lg-end">
            <a
              ...
              // data-bs-target="#Rega_modal_filter_performance"
              onClick={(event) => {
...
export default PmoReportsIndicatorsPerformanceIndicatorsToolbar;
