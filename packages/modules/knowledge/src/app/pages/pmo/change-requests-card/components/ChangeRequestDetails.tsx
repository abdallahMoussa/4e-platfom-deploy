        ...
        <div className="card card-xl-stretch mb-xl-0">
          <div className="card-header px-3 pt-3 pb-2  d-flex bg-light  border-secondary border-0 border-top-1 border-bottom-1 border-dashed   mx-7 mt-10 mb-5 ">
            <h3 className="card-title align-items-start flex-column">
              <span className="card-label fw-bolder fs-4 mb-2 ">{intl.formatMessage({ id: "CHAGE.REQUEST.DATA"})}</span>
            ...
            <div className="card-toolbar">
              <div className="d-flex justify-content-between align-items-center mt-3 mt-lg-0 justify-content-lg-end mb-5">
                <Link to={"/pmo-add-new-change-request"} className="btn btn-secondary mx-1 me-3 mw-100 text-center">
                  {intl.formatMessage({ id: "ADD.CHANGE"})}
                </Link>
                <Link to={"/pmo-edit-new-change-request"} className="btn btn-primary mx-1 me-3 mw-100 text-center">
              ...
              <div className="tab-pane fade active show" id="REGA_table_widget_5_tab_1">
                <div className="mx-5">
                  <div className="d-flex mb-10 pt-2 border-secondary border-0 border-bottom-1 border-dashed pb-3 align-items-center">
                    ...
                    <p className="px-2 mb-5 fw-bolder fontSz-7 pb-2 text-primary fw-bold">عنوان طلب التغيير</p>
                  </div>
                  <div className="d-flex mb-10 pt-2 border-secondary border-0 border-bottom-1 border-dashed pb-3 align-items-center">
                  ...
                  <div className="d-flex mb-10 pt-2 border-secondary border-0 border-bottom-1 border-dashed pb-3 align-items-center">
                    ...
                    <div className="d-inline py-2 px-7 fw-bolder fs-6 badgex badge-light-danger">{intl.formatMessage({ id: "LOW"})}</div>
                    </p>
                  </div>
                  <div className="d-flex mb-10 pt-2 border-secondary border-0 border-bottom-1 border-dashed pb-3 align-items-center">
                    <p className="pb-2 mb-5 fontSz-6"> {intl.formatMessage({ id : "DATE.ORDER"})} :</p>
                    <p className="px-2 mb-5 fontSz-7 pb-2 text-muted fw-bold">25 Jun 2022</p>
                  </div>
                  <div className="d-flex mb-10 pt-2 border-secondary border-0 border-bottom-1 border-dashed pb-3 align-items-center">
                    <p className="pb-2 mb-5 fontSz-6"> {intl.formatMessage({ id : "CHANGE.TYPE"})} :</p>
                  ...
                  <div className="d-flex mb-10 pt-2 border-secondary border-0 border-bottom-1 border-dashed pb-3 align-items-center">
                    <p className="pb-2 mb-5 fontSz-6"> {intl.formatMessage({ id : "ORDER.REASON"})} :</p>
                    <p className="px-2 mb-5 fontSz-7 pb-2 text-muted fw-bold">الملاحظات المهمة للمشروع, الملاحظات المهمة للمشروع, الملاحظات المهمة للمشروع,</p>
                  </div>
