...
import SystemsAndservicesFilterPopup from "../popup/SystemsAndservices-filter-popup";

const SystemsAndServicesToolbar: FC = () => {
  const intl = useIntl();
      ...
      <div className="toolbar py-5 py-lg-15" id="kt_toolbar">
        <div id="kt_toolbar_container" className="container-xxl d-flex flex-stack flex-wrap p-0">
          <div className="page-title d-flex flex-column me-3">
            <h1 className="d-flex text-white fw-bolder my-1 fs-3">{intl.formatMessage({ id: "ViewAllCards" })}</h1>
            <ul className="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
              ...
              <li className="breadcrumb-item text-white opacity-75">{intl.formatMessage({ id: "ViewAllCards" })}</li>
            </ul>
          </div>
          <div className="d-flex align-items-center py-3 py-md-1">
            ...
            <div>
              <Link to={`/systems-services-settings/add-system`} className="btn btn-bg-white btn-active-color-primary">
                {intl.formatMessage({ id: "AddSystem" })}
              </Link>
            </div>
          </div>
        </div>
        <div className="modal fade" aria-hidden="true">
          <SystemsAndservicesFilterPopup handleClose={handleClose} show={show} />
        </div>
      </div>
    </>
  );
...
export { SystemsAndServicesToolbar };
