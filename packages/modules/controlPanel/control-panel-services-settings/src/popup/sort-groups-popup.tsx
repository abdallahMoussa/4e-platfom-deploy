...
type AllcardsSortGroupsPopupProps = {
  show?: any;
  handleClose?: any;
};
const ViewallcardsSortGroupsPopup: React.FC<AllcardsSortGroupsPopupProps> = ({
  show,
  handleClose,
}) => {
  const intl = useIntl();
...
export default ViewallcardsSortGroupsPopup;
