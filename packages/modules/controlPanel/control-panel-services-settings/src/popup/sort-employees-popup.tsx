...
type AllcardsSortEmployeesPopupProps = {
  show?: any;
  handleClose?: any;
};
const ViewallcardsSortEmployeesPopup: React.FC<
  AllcardsSortEmployeesPopupProps
> = ({ show, handleClose }) => {
  const intl = useIntl();
                        ...
                        <div className="input-group">
                          <div className="input-group-prepend">
                            <span className="input-group-text">
                              <i className="special bi bi-person-workspace"></i>
                            </span>
                          </div>
                          <input
                            type="text"
...
export default ViewallcardsSortEmployeesPopup;
