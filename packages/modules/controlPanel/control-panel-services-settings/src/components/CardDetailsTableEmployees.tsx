...
import { ViewAllcardsCardDetailsTableEmployeeSettings } from "./CardDetailsTableEmployeeSettings";
import ViewallcardsSortEmployeesPopup from "../popup/sort-employees-popup";

const ViewAllcardsCardDetailsTableEmployees: FC = () => {
  const intl = useIntl();
      ...
      >
        <div className="content flex-row-fluid" id="kt_Detailscontent">
                ...
                <div className="py-5 taskLogs">
                  <div className="table-responsive">
                    <table className="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                      ...
                      <tbody>
                        <ViewAllcardsCardDetailsTableEmployeeSettings
                          mark1={xyMark.x}
                          mark2={xyMark.y}
                          mark3={xyMark.y}
                          mark4={xyMark.x}
          ...
          <div className="modal fade" aria-hidden="true">
            <ViewallcardsSortEmployeesPopup
...
export { ViewAllcardsCardDetailsTableEmployees };
