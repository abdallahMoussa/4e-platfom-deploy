...
import { ViewallcardsCardDetailsTableDepartmentSettings } from "./CardDetailsTableDepartmentSettings";
import ViewallcardsSortDepartmentsPopup from "../popup/sort-departments-popup";

const ViewAllcardsCardDetailsTableDepartments: FC = () => {
  const intl = useIntl();
      ...
      >
        <div className="content flex-row-fluid" id="kt_Detailscontent">
                  ...
                  <div className="d-flex flex-column flex-md-row justify-content-center justify-content-md-between align-items-start align-items-md-center w-100">
                    ...
                    <div className="d-flex justify-content-end align-items-center">
                      <a
                        ...
                        data-bs-target="#rega_modal_viewallcard_departmentsSort"
                      >
                ...
                <div className="py-5 taskLogs">
                  <div className="table-responsive">
                    <table className="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                      ...
                      <tbody>
                        <ViewallcardsCardDetailsTableDepartmentSettings />
                        <ViewallcardsCardDetailsTableDepartmentSettings />
                        <ViewallcardsCardDetailsTableDepartmentSettings />
                        <ViewallcardsCardDetailsTableDepartmentSettings />
                      </tbody>
          ...
          <div
            ...
            id="rega_modal_viewallcard_departmentsSort"
            aria-hidden="true"
          >
            <ViewallcardsSortDepartmentsPopup />
          </div>
        </div>
      </div>
    </>
...
export { ViewAllcardsCardDetailsTableDepartments };
