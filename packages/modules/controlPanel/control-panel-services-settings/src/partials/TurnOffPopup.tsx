...
type PopupProps = {
  ...
  id?:string;
  additionalData?: {};
  handelstop?: (id: string, additionalData: {}) => void;
};

export const TurnOffPopup: FC<PopupProps> = ({ show, handleClose,id='',additionalData={},handelstop=null }) => {
  const intl = useIntl();
