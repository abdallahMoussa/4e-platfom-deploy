...
import {  fetchUserRoles, removeUserRoleAsync } from "../../../features/role-user/roleUserSlice";
...
export const RoleUsersActions: FC<ActionProps> = ({
  userId,
  RoleId,
  ...
  const handleDeleteClick = () => {
    let data: DeleteUserRoleModel = {
      userId: userId,
      id: RoleId,
    };
    let id = `${RoleId}`;

    dispatch(removeUserRoleAsync(data) as any).then((result:any) => {
   ...
   // dispatch(removeUserRoleAsync(data) as any);
  //  console.log("id",id);
      ...
      <Dropdown as={ButtonGroup}>
        ...
        <Dropdown.Menu>
          <Dropdown.Item as="button">
            <Link
              to={`/admin-panel-users/details/${userId}`}
