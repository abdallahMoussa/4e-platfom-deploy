...
export const SavePopup: FC<PopupProps> = ({ show, handleClose }) => {
  const intl = useIntl();
  const showSuccessAlert = () => {
    Swal.fire({
      text: intl.formatMessage({ id: "SavedSuccessfully" }),
      icon: "success",
      heightAuto: false,
      ...
      >
            ...
            <Row className="justify-content-center mt-5 mb-10">
              <Modal.Title id="contained-modal-title-vcenter">
                <div className="text-center">
                  <h3> {intl.formatMessage({ id: "SaveConfirmation" })}</h3>
                </div>
              </Modal.Title>
            </Row>
          </div>
        ...
        <Modal.Body className="pb-0">
          <Row className="justify-content-center mb-5">
            <div className="text-center">
              <h5>
                {intl.formatMessage({ id: "AreYouSureToSaveTheRequest" })}
              </h5>
            </div>
          </Row>
        </Modal.Body>
        <div className="row">
          <div className="col-12 col-lg-7 mx-auto mb-15 mt-5">
