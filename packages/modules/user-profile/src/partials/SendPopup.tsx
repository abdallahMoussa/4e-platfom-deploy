...
export const SendPopup: FC<PopupProps> = ({ show, handleClose }) => {
  const intl = useIntl();
  const showSuccessAlert = () => {
    Swal.fire({
      text: intl.formatMessage({ id: "SendedSuccessfully" }),
      icon: "success",
      heightAuto: false,
      ...
      >
            ...
            <Row className="justify-content-center mt-5 mb-20">
              <Modal.Title id="contained-modal-title-vcenter">
                <div className="text-center">
                  <h3> {intl.formatMessage({ id: "SendConfirmation" })}</h3>
                </div>
              </Modal.Title>
            </Row>
          </div>
        ...
        <Modal.Body className="pb-0">
          <Row className="justify-content-center mb-5">
            <div className="text-center">
              <h5>{intl.formatMessage({ id: "AreYouSureToSend" })}</h5>
            </div>
          </Row>
        </Modal.Body>
