...
const userAccountAxiosInstance = axios.create({
  baseURL: `http://ncvc.4explain.net:5111/api`,
  //  baseURL: `http://localhost:5111/api`,
});

// Add request interceptor
userAccountAxiosInstance.interceptors.request.use(
  function (config) {
...
userAccountAxiosInstance.interceptors.response.use(
  function (response) {
...
export default userAccountAxiosInstance;
