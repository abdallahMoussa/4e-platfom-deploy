...
const userOrgsAxiosInstance = axios.create({
  baseURL: `http://ncvc.4explain.net:5041/api`,
  //  baseURL: `http://localhost:5111/api`,
});

// Add request interceptor
userOrgsAxiosInstance.interceptors.request.use(
  function (config) {
...
userOrgsAxiosInstance.interceptors.response.use(
  function (response) {
...
export default userOrgsAxiosInstance;
