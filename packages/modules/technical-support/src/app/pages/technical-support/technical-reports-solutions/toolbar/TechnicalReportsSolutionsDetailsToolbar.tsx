...
function TechnicalReportsSolutionsDetailsToolbar() {
  let intl = useIntl();
  return (
    <Fragment>
        ...
        >
          <div className="page-title d-flex flex-column me-3">
            <h1 className="d-flex text-white fw-bolder my-1 fs-2">
              {intl.formatMessage({ id: "TechnicalReportsSolutionsDetails" })}
            </h1>
...
export default TechnicalReportsSolutionsDetailsToolbar;
