...
function AddingNewSolutionToTechnicalSupportReportsToolbar() {
  let intl = useIntl();
  return (
    <Fragment>
        ...
        >
          <div className="page-title d-flex flex-column me-3">
            <h1 className="d-flex text-white fw-bolder my-1 fs-2">
              {intl.formatMessage({
                id: "AddingNewSolutionToTechnicalSupportReports",
              })}
            </h1>
            <ul className="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
              ...
              <li className="breadcrumb-item text-white opacity-75">
                ...
                >
                  {" "}
                  {intl.formatMessage({ id: "TechnicalReportsSolutions" })}
                  {/* {localStorage.getItem("solutionsName")} */}
...
export default AddingNewSolutionToTechnicalSupportReportsToolbar;
