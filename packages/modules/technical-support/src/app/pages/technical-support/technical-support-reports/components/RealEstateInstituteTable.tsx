...
const RealEstateInstituteTable = () => {
    let intl = useIntl();
  ...
  let location = useLocation();
    return(
        ...
        <div className="d-flex justify-content-end mb-5">
            ...
            <div className="d-flex justify-content-between align-items-end mt-3 mt-lg-0 justify-content-lg-end">
              <ExportDropDown />       
            </div>
          </div>
        </div>
...
export {RealEstateInstituteTable}