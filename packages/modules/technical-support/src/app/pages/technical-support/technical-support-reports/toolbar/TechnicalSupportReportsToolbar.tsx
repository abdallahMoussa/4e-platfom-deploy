...
const TechnicalSupportReportsToolbar: FC = () => {
  const intl = useIntl()
  ...
  return <>
    ...
    <div id="kt_toolbar_container" className="container-xxl d-flex flex-stack flex-wrap p-0">
      <div className="page-title d-flex flex-column me-3">
        <h1 className="d-flex text-white fw-bolder my-1 fs-3">{intl.formatMessage({ id: "CommunicationsReport" })}</h1>
...
export { TechnicalSupportReportsToolbar }