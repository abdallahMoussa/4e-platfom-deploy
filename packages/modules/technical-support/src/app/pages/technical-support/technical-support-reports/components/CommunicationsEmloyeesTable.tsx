...
import FilterCommunicationsEmployees from "../popup/filter-communications-employees-popup";


const CommunicationsEmloyeesTable = () => {
    let intl = useIntl();
    ...
    return(
        ...
        <div className="d-flex justify-content-end mb-5">
            ...
            <div className="d-flex justify-content-between align-items-center mt-3 mt-lg-0 justify-content-lg-end">
              <div data-bs-toggle="modal" data-bs-target="#FilterCommunicationsEmployees" className="btn btn-secondary w-bolder mx-1 text-center mw-100">
        ...
        <div className="modal fade" id="FilterCommunicationsEmployees" aria-hidden="true">
        <FilterCommunicationsEmployees />
        </div>
        </Fragment>
    );
}

export {CommunicationsEmloyeesTable}