...
function TechnicalSupportFeedbacksManagerApprovalRequestDetailsToolbar() {
  let intl = useIntl();
  return (
    <Fragment>
        ...
        >
          <div className="page-title d-flex flex-column me-3">
            ...
            <ul className="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
              ...
              <li className="breadcrumb-item text-white opacity-75">
                {intl.formatMessage({
                  id: "TechnicalSupportSystemManager",
                })}
              </li>
              <li className="breadcrumb-item">
                <span className="bullet bg-white opacity-75 w-5px h-2px"></span>
              ...
              <li className="breadcrumb-item text-white opacity-75">
                <Link
                  to="/technical-support-feedbacks-manager"
                  className="text-white text-hover-primary"
                >
                  {intl.formatMessage({
...
export default TechnicalSupportFeedbacksManagerApprovalRequestDetailsToolbar;
