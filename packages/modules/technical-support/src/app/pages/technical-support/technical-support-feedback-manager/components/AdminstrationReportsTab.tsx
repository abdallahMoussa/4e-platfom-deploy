      ...
      <div className="card-body pb-7">
        ...
        <div className="d-flex flex-wrap mb-7 bg-light">
          ...
          >
            ...
            <span
              className={`bg-warning h-fit  opacity-75 w-fit mx-3 text-dark ${
                intl.locale == "ar" ? "p-1" : ""
              }`}
            >
              15
          ...
          >
            ...
            <span
              className={`bg-danger h-fit  opacity-75 w-fit text-dark mx-3 ${
                intl.locale == "ar" ? "p-1" : ""
              }`}
            >
              15
          ...
          >
            ...
            <span
              className={`bg-secondary h-fit  opacity-75 w-fit text-dark mx-3 ${
                intl.locale == "ar" ? "p-1" : ""
              }`}
            >
              15
