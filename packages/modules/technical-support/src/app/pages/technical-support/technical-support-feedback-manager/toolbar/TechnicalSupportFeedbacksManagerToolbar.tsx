...
import FilterPop from "../popups/FilterPopup";

const TechnicalSupportFeedbacksManagerToolbar: FC = () => {
  const intl = useIntl();
  ...
  return (
    <>
      <Fragment>
        ...
        <FilterPop show={filterShow} handleClose={() => setFilterShow(false)}/>
      </Fragment>
    </>
  );
};

export { TechnicalSupportFeedbacksManagerToolbar };
