...
const CurrentServiceReportToolbar: FC = () => {
  let intl = useIntl();
  return (
    <>
      <Fragment>
          ...
          >
            <div className="page-title d-flex flex-column me-3">
              <h1 className="d-flex text-white fw-bolder my-1 fs-2">
                ...
                {/* {localStorage.getItem("currentServiceReportName")} */}
              </h1>
            ...
            <div className="card-toolbar ">
              <div className="d-flex justify-content-between align-items-center mt-3 mt-lg-0 justify-content-lg-end">
                ...
                >
                  {intl.formatMessage({ id: "NewServiceRequest" })}
                </Link>
              </div>
            </div>
          </div>
...
export { CurrentServiceReportToolbar };
