...
function TechnicalSupportFeedbacksManagerApprovalDetails() {
  let intl = useIntl();
  ...
  return (
    <Fragment>
      ...
      <RejectReportPopup show={rejectReportShow} handleClose={() => setRejectReportShow(false)}/>
    </Fragment>
  );
}

export default TechnicalSupportFeedbacksManagerApprovalDetails;
