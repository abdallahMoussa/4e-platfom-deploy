...
function TechnicalSupportFeedbacksManager() {
  let intl = useIntl();
  ...
  return (
    <Fragment>
      ...
      <FilterPopup />
      {/* <RedirectPopup />
      <DelayPopup  show={delaymodalShow} handleClose={() => setDelayModalShow(false)}/> */}
    </Fragment>
  );
}

export default TechnicalSupportFeedbacksManager;
