...
const TechnicalSupportFeedbacksAdministrationEmployeeDetailsToolbar: FC =
  () => {
    const intl = useIntl();
          ...
          >
            <div className="page-title d-flex flex-column me-3">
              ...
              <ul className="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                ...
                <li className="breadcrumb-item text-white opacity-75">
                  <Link
                    to="/technical-support-feedbacks-administration-employee"
                    className="text-white text-hover-primary"
                  >
                    {intl.formatMessage({
...
export { TechnicalSupportFeedbacksAdministrationEmployeeDetailsToolbar };
