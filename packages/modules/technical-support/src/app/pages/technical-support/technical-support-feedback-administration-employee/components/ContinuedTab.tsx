    ...
    <Fragment>
      <div
        className={`tab-pane fade  ${
          searchParams.get("tabName") == "continued-reports" ? "show" : ""
        }`}
                    ...
                    return (
                      <Fragment key={Math.random()}>
                        <tr>
                          ...
                          <td>
                            <p
                              className="text-primary fs-5 text-center p-0 m-0 cursor-pointer"
                              onClick={() => {
                                navigate(
