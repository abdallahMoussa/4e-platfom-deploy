...
import { AddPopup } from "../../../../../app/pages/partials/AddPopup";
          ...
          <div className="row mb-4">
            <div className="col-lg-6">
              <div className="mb-2 pt-2 pb-3 ">
                ...
                >
                  {intl.formatMessage({ id: "ServiceTitle" })}
                </label>
                <div className="input-group">
                  <div className="input-group-prepend">
                    <span className="input-group-text">
                      <i className="bi bi-gear-fill special"></i>
                    </span>
                  </div>
                  <input
                    id="ReportTitle"
                    ...
                    placeholder={intl.formatMessage({ id: "ServiceTitle" })}
                  />
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-6">
              <div className="mb-2 pt-2 pb-3">
                ...
                <select
                  id="ReportType"
                  className="form-select myform-control inputHeight form-select-solid select2-hidden-accessible not-allowed"
                  data-kt-select2="true"
                  data-placeholder={intl.formatMessage({ id: "ServiceType" })}
            ...
            <div className="col-lg-6">
              <div className="mb-2 pt-2 pb-3">
                <label
                  ...
                  className="form-label px-2 fontSz-6"
                >
                  {intl.formatMessage({ id: "ServiceSubCategory" })}
                </label>
            ...
            <div className="col-lg-5 card  shadow h-450px ">
              <div className="w-100">
                ...
                >
                  ...
                  >
                    <button
                      className={`nav-link btn btn-active-color-primary rounded-0 w-100 fs-5 m-1 fw-bolder ${
