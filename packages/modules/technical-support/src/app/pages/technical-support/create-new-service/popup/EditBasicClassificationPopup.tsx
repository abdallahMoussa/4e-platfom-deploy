...
const EditBasicClassificationPopup: React.FC<PopupProps> = ({
  show,
  handleClose,
}) => {
  const intl = useIntl();
                ...
                <Modal.Title>
                  <h3 className="card-title flex-column align-items-center">
                    <span className="card-label fw-bolder fs-3 mb-2 ">
                      {intl.formatMessage({ id: "EditingBasicClassification" })}
                    </span>
            ...
            <Modal.Body>
              <div className="row mb-3">
                ...
                <div className="col-4">
                  <div className="mb-2 pt-2 pb-3 ">
                    <label className="form-label px-2  fs-6 text-gray-700">
                      {intl.formatMessage({ id: "SubordinateManagement" })}
                    </label>
                    <select
                      id="domain"
                ...
                <div className="col-6">
                  <div className="mb-2 pt-2 pb-3 ">
                    ...
                    <div className="input-group">
                      <div className="input-group-prepend">
                        <span className="input-group-text">
                          <i className="fa-solid fa-icons special"></i>
                        </span>
                      </div>
                      <input
                        className="form-control"
                ...
                <div className="col-6">
                  <div className="mb-2 pt-2 pb-3 ">
                    ...
                    <div className="input-group">
                      <div className="input-group-prepend">
                        <span className="input-group-text">
                          <i className="fas fa-palette special"></i>
                        </span>
                      </div>
                      <input
                        className="form-control"
...
export default EditBasicClassificationPopup;
