...
export const AddEscalationLevelToolbar: FC = () => {
  const intl = useIntl();
        ...
        >
          <div className="page-title d-flex flex-column me-3">
            <h1 className="d-flex text-white fw-bolder my-1 fs-3">
              {intl.formatMessage({ id: "AddNewAgreement" })}
            </h1>
            <ul className="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
              ...
              <li className="breadcrumb-item text-white opacity-75">
                <Link
                  to="/technical-support-service-level-agreement-details"
                  className="text-white text-hover-primary"
                >
              ...
              <li className="breadcrumb-item text-white opacity-75">
                {intl.formatMessage({ id: "AddEsclationLevel" })}
              </li>
            </ul>
          </div>
        </div>
